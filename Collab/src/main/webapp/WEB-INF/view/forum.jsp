    ...
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            <div class="account-wall">
				<h1 class="text-center login-title"><i>Forum Post</i></h1>
                <form:form action="./forum1" commandName="frum" role="form" class="form-signin">
				<div class="form-group">
				
				<label for="inputName" class="center control-label">Questions</label>
				<div>
                <form:input path="question"  type="text" class="form-control" placeholder="Post the Questions"/>
				</div>
				</div>
				<div class="form-group">
				
				<label for="inputName" class="center control-label">Author</label>
				<div>
                <form:input path="author"  type="text" class="form-control" placeholder="Enter the Author"/>
				</div>
				</div>
				<div class="form-group">
				<label for="Address" class="left control-label">Blog Content</label>
				<div>
                <form:textarea path="summery" type="text" style="background: transparent;" class="form-control" rows="4" placeholder="Content" /></textarea>
				</div>
				</div>					
                <button class="btn" type="submit">
                    Post</button>
                </form:form>
                <a href="forumlist">list forum</a>
            </div>
