...
<h2 style="color: #ff4d4d;" class="text-center"><strong>Pendrive Point</strong></h2>
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" ><img src="logo2.jpg" style="width:80px;height:35px;"></a>
    </div>
...
<ul class="nav navbar-nav navbar-right">
    ...
    <div class="container">
        <div class="row">
         ...
         <h3>
        <p style="color: #9932cc;">Store and share your world with USB Flash Drives. Available in a variety of styles to meet all your storage needs.
          </form>
        </div>
    </div>
</div>
